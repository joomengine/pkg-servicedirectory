<?php
/**
 * @package    Joomla.Service.Directory
 *
 * @created    30th April, 2015
 * @author     Llewellyn van der Merwe <https://dev.vdm.io>
 * @git        Joomla Service Directory <https://git.vdm.dev/joomla/Service-Directory>
 ...
 */
class pkg_servicedirectoryInstallerScript
{
	/**
	...
	{
		$location = "https://raw.githubusercontent.com/joomengine/Joomla-Service-Directory/refs/heads/6.x/update_server.xml";
		$elements = ['pkg_servicedirectory', 'com_servicedirectory'];
